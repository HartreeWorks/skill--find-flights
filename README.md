...
A Claude Code skill for searching and comparing flight options across flexible
dates, with ranked recommendations based on price, routing, baggage, seats, and
time trade-offs.
...
```bash
# Run install
npx skills add HartreeWorks/skill--find-flights
